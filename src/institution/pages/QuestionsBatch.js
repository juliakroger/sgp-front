        ...
        <div className="content">
          ...
          <Modal title="Qual tipo de questão voce deseja cadastrar?"
            ...
            <div className="text-center">
              <Link to='/home/create/discursive'><p id="discursive_question"
                                                    className="btn btn-success m-r-12 pull-right mr-2">Discursiva</p>
              </Link>
              <Link to='/home/create/objective'><p id="objective-question"
