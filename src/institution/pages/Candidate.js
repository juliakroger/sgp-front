            ...
            <div className="content">
                ...
                <div aria-label="Page navigation example">
                    <ul className="pagination justify-content-center pagination-sm">
                        <li className="page-item"><p id={this.state.page-1} className="page-link" onClick={this.paginationHandler}>Previous</p></li>
                        <li className="page-item"><p id={this.state.page}  className="page-link" onClick={this.paginationHandler}>{this.state.page+1}</p></li>
                        <li className="page-item"><p id={this.state.page+1}  className="page-link" onClick={this.paginationHandler}>{this.state.page+2}</p></li>
                        <li className="page-item"><p id={this.state.page+2}  className="page-link" onClick={this.paginationHandler}>{this.state.page+3}</p></li>
                        <li className="page-item"><p id={this.state.page+3}  className="page-link" onClick={this.paginationHandler}>Next</p></li>
                    </ul>
                </div>
            </div>
        )
