  ...
  return (
      <div className="candidate-dashboard">
        ...
        <a id="questionarios" className=""
          ...
          <div className="candidate-dashboard-item">
            <img alt='candidate-online-test'
                 src="https://cdn.starlinetecnologia.com.br/images/candidate_online_test.png"/>
        ...
        <a id="requerimentos" className="" href="/demo/appeal/candidateappeal/46c03dea-1f0d-11e9-8187-0242ac11001b/">
          <div className="candidate-dashboard-item">
            <img alt='candidate-requirements'
                 src="https://cdn.starlinetecnologia.com.br/images/candidate_requirements.png"/>
